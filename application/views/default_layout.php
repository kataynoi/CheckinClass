...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo site_url();?>">Checkin Class</a>
        </div>
        <!-- /.navbar-header -->
<?php
...
?>
        <ul class="nav navbar-top-links navbar-right">
            ...
            <?php }else{ ?>
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="<?php echo site_url('users/logout')?>">
                    <i class="fa fa-user fa-fw"></i> <i class="fa fa-caret-down"></i> Loginx
                </a>
                <!-- /.dropdown-user -->
            </li>
            <?php }?>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo site_url()?>"><i class="fa fa-dashboard fa-fw"></i> Dashboardxx</a>
                        </li>
                        <li>
