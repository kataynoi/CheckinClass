        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        ตรวจสอบการบันทึกข้อมูลเวชระเบียนผู้ป่วยนอก คะแนน <span class="badge info" id=""></span>
                    </div>
                    <div class="panel-body">
                        <form role="form">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="icon-remove"></i>
                        ปิดหน้าต่าง
                    </button>
                </div>
            </div>
